...
- [StormWatch Live project](project_stormwatch.md) — File: C:\Users\aphil\Documents\Stormwatch\weather-alerts.html · HTTP server required for USGS layer · backups through 2026-05-17
- [StormWatch Vision & Roadmap](project_vision.md) — Full strategic roadmap: Chat Panel, NSSL overlays, GitHub, accessibility, NVIDIA/MCP expansion, forecasting agents
- [StormWatch recovery procedure](recovery_stormwatch.md) — THREE backup sets taken 2026-05-17 pre-GitHub (Stormwatch folder + Desktop + Documents); GitHub abort procedure; local-only startup commands
- [Cases 1 & 2 — Missoula hindcasts](hindcast_missoula_derecho.md) — Cases 1+2 COMPLETE; PNTM8=correct Point Six coords; all scripts listed
