...
- **DEM TERRAIN FEATURES COMPLETE — all 164 active rows (2026-06-12, commit 9f88630).** merge_all_remaining_dem.py merged 69 rows across 8 events: boulder_chin2021 (9), camp_2018 (13), iowa_derecho2020 (2), kincade_ign_2019 (10), marshall_2021 (8), missoula_dec2025 (8), missoula_jul2024 (18), woolsey_2018/CUUC1 (1). CUUC1/woolsey synthesized from CUUC1/thomas_2017 (same coordinates). Final distribution: exposed_ridge=63, canyon_gap=29, open=43, valley=29. Key corrections: HWKC1/kincade_ign confirmed exposed_ridge; PNTM8/missoula_jul is canyon_gap (gentle slope despite high relief); CUUC1 is open at both events.
