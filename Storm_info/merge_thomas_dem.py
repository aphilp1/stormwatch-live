...
for all thomas_2017 rows with NEEDS_DEM values.
"""
...
# Backup
backup = MAIN.replace('.csv', '_pre_thomas_dem.csv')
...
print(f'NEEDS_DEM remaining in active thomas rows: {len(remaining)}')
if remaining:
